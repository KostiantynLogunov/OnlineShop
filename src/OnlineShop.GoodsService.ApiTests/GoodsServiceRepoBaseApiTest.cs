...
{
    public abstract class GoodsServiceRepoBaseApiTest<TClient, TEntity>
        ...
        where TEntity : IIdentifiable
    {
        ...
        public GoodsServiceRepoBaseApiTest()
        {
            ConfigureFixture();
        }
            ...
            switch (env)
            {
                case "Docker":
                    serviceAdressOptionsMock.Setup(m => m.Value)
                        ...
                        {
                            GoodsService = "http://localhost:5006",
                ...
                default:
                    serviceAdressOptionsMock.Setup(m => m.Value)
                        .Returns(new ServiceAdressOptions()
                        {
                            GoodsService = "https://localhost:5007",
